...
From the perspective of maintaining sustainable water usage during the California drought, it seems useful to reduce production of water intensive products. A personal level of activism by changing consumption may or may not be influential in changing hugely profitable agricultural practices. But it is a question that is out there. The answer to that question is to eat less meat, fewer nuts, and more Brazil nuts, and more imported food in general. Hope that helps out. 
