...
The second column shows the amount of water (in Liters) used to produce just one gram of protein in that food. The third column shows the percent of protein by mass that that food contains. We want the food that uses the least water that has the highest percentage of protein. 
